...
Remarque : Soit (iii) tout s.e.v de $E$ stable par $u$ admet un supplémentaire
...
Remarque : Une base de vecteurs propres de $u$ l'est aussi de $u^p$.
...
Rem : Si $f$ est diagonalisable, soit $(\varepsilon_1,\dots,\varepsilon_n)$ base
